...
describe('Sightings / Geolocalización & Módulos desconectados', () => {
    ...
    describe('1. Verificación de módulos desconectados', () => {
        it('No debe tener registrados en mongoose los modelos eliminados', () => {
            const registeredModels = Object.keys(mongoose.models);
            expect(registeredModels).not.toContain('Comment');
        ...
        it('Las rutas de /comments, /events, /forums, /reactions deben responder 404', async () => {
            const commentRes = await request(app).get('/api/v1/comments/all');
